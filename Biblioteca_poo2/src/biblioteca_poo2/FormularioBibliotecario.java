...
public class FormularioBibliotecario extends JFrame {
	static FormularioBibliotecario frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new FormularioBibliotecario();
	...
	public FormularioBibliotecario() {
		...
		JLabel lblAddLibrarian = new JLabel("Adicionar Bibliotecario");
		...
		JLabel lblContactNo = new JLabel("Numero de Contato:");
		...
		JButton btnNewButton = new JButton("Adicionar Bibliotecario");
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=BibliotecarioDao.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(FormularioBibliotecario.this,"Bibliotecaria adicionado com sucesso!");
				AdminSucesso.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(FormularioBibliotecario.this,"Erro ao salvar");
			}
			}
		});
