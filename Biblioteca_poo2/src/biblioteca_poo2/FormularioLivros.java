...
public class FormularioLivros extends JFrame {
	static FormularioLivros frame;
	...
	public FormularioLivros() {
		...
		JLabel lblAddBooks = new JLabel("Adicionar Livros");
		...
		JButton btnAddBooks = new JButton("Adicionar Livro");
		btnAddBooks.addActionListener(new ActionListener() {
			...
			int i=LivroDao.save(callno, name, author, publisher, quantity);
			if(i>0){
				JOptionPane.showMessageDialog(FormularioLivros.this,"Livros Adicionados com Sucesso!");
				Bibliotecario_Sucesso.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(FormularioLivros.this,"Não foi possivel salvar as alterações!");
			}
			}
		});
