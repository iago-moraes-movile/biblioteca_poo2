		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeletarBibliotecario.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=LibrarianDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeletarBibliotecario.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeletarBibliotecario.this,"Unable to delete given id!");
					}
				}
			}
		});
