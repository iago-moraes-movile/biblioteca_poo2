...
public class AdminSucesso extends JFrame {
	static AdminSucesso frame;
	...
	public AdminSucesso() {
		...
		JLabel lblAdminSection = new JLabel("Secao Admin");
		...
		JButton btnViewLibrarian = new JButton("Ver Bibliotecario");
		btnViewLibrarian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			VisaoBibliotecario.main(new String[]{});
			}
		});
		btnViewLibrarian.setFont(new Font("Tahoma", Font.PLAIN, 15));
		
		JButton btnDeleteLibrarian = new JButton("Apagar Bibliotecario");
		btnDeleteLibrarian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			DeletarBibliotecario.main(new String[]{});
			frame.dispose();
			}
		});
