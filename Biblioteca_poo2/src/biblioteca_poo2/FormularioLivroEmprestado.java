...
public class FormularioLivroEmprestado extends JFrame {
	static FormularioLivroEmprestado frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new FormularioLivroEmprestado();
	...
	public FormularioLivroEmprestado() {
		...
		JLabel lblNewLabel = new JLabel("Emprestar Livro");
		...
		JLabel lblStudentContact = new JLabel("Contato:");
		
		JButton btnIssueBook = new JButton("Emprestar");
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(LivroEmprestadoDao.checkBook(bookcallno)){
			
			int i=LivroEmprestadoDao.save(bookcallno, studentid, studentname, studentcontact);
			if(i>0){
				JOptionPane.showMessageDialog(FormularioLivroEmprestado.this,"Livro emprestado com sucesso!");
				Bibliotecario_Sucesso.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(FormularioLivroEmprestado.this,"Não é possivel emprestar o livro!");
			}//end of save if-else
			
			}else{
				JOptionPane.showMessageDialog(FormularioLivroEmprestado.this,"Não existe este emprestimo!");
		...
		JLabel lblNewLabel_1 = new JLabel("Nota: Por favor verifique o RA do aluno antes de emprestar o livro!");
